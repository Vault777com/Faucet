...
async function displayContractVerification(address, element) {
    ...
    try {
        // Use Etherscan V2 API to check if the contract is verified
        // Note: In a production app, you would use a backend proxy to avoid exposing your API key
        const apiKey = "E4NKRI57958WGIN6JH35KIY6JCJIK5EYVP"; // This should be kept private in a real app
        const apiUrl = `https://api.etherscan.io/v2/api?chainid=421614&module=contract&action=getabi&address=${address}&apikey=${apiKey}`;
